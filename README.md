...
[![R build status](https://github.com/extendr/helloresult/workflows/R-CMD-check/badge.svg)](https://github.com/extendr/helloresult/actions)
...
```r
remotes::install_github("extendr/helloresult")
```
